    ...
    public partial class InitialMigrate3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CargoAsignado", x => new { x.UserId, x.RoleId });
                    table.ForeignKey(
                        name: "FK_CargoAsignado_AspNetUserRoles_UserId_RoleId",
